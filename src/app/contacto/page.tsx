...
const ContactForm: React.FC = () => {
  ...
  const handleSubSelect = (subOption: Option) => {
    ...
    <div className="flex flex-col min-h-[100dvh]">
      ...
      <div>
        <Image
          ...
          height="1080"
          alt="Logo instituto"
          className="w-full rounded-xl object-cover aspect-[2/1] lg:h-[350px]"
        />
      </div>
      <div className="w-full max-w-5xl mx-auto py-12 md:py-24 px-4 md:px-6">
        <div className="grid md:grid-cols-2 gap-12">
          <div>
            ...
            <form className="space-y-4" onSubmit={handleSubmit}>
              ...
              <div className="space-y-2">
                ...
                >
                  <SelectTrigger className="text-gray-500 dark:text-black w-full">
              ...
              <Button
                type="submit"
                className="bg-customColor-iesa hover:bg-slate-500"
              >
                Enviar
              </Button>
            </form>
          ...
          <div className="space-y-6">
            <div>
              <h2 className="text-2xl font-bold mb-2">Direccion</h2>
