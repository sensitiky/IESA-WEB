...
const CookieNotice: React.FC = () => {
  ...
  return (
    isVisible && (
      <section
        ref={sectionRef}
        className="fixed max-w-md p-4 mx-auto bg-white border border-gray-200 dark:bg-gray-800 left-12 bottom-16 dark:border-gray-700 rounded-2xl z-40"
        onClick={() => {
          setIsVisible(false);
          localStorage.setItem('hasSeenCookieNotice', 'true');
        }}
      >
        ...
        <div className="flex items-center justify-between mt-4 gap-x-4 shrink-0">
          ...
          <button className="text-xs bg-customColor-iesa font-medium rounded-lg hover:bg-gray-700 text-white px-4 py-2.5 duration-300 transition-colors focus:outline-none">
            Aceptar
          </button>
        </div>
      </section>
